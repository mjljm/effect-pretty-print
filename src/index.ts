...
import { HashSet, Match, MutableHashMap, Option, Order, ReadonlyArray, Tuple, pipe } from 'effect';
...
export const defaultFormatter = (value: unknown): Option.Option<FormattedString.FormattedString> =>
	pipe(
